  ...
  <Centered column>
    <WarningMessage className="p-3">
      ...
      <p className="has-text-justified">
        После создания бронирования СКК «МРИЯ» направляет письмо сотруднику
        (на почту, указанную при бронировании путёвки)
        о необходимости подтвердить статус «Близкий член семьи сотрудника»
      </p>
    </WarningMessage>
